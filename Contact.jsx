        ...
        <section className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col justify-center animate-slide-in-left">
            ...
            <div className="flex space-x-4 mt-2">
              <a href="#" className="text-green-600 hover:text-green-800 transition animate-fade-in delay-200"><FaLinkedin size={24} /></a>
              <a href="#" className="text-green-600 hover:text-green-800 transition animate-fade-in delay-300"><FaTwitter size={24} /></a>
              <a href="#" className="text-green-600 hover:text-green-800 transition animate-fade-in delay-400"><FaFacebook size={24} /></a>
            </div>
          </div>
          {/* Contact Form */}
