...
const WorkingProfessional = () => {
  ...
  const availableProjects = [
    ...
    },
    {
      ...
      skills: ["JavaScript", "API Development", "Authentication"],
        ...
        {activeTab === 'available' && (
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="mt-1 text-sm text-gray-500">Projects looking for guidance in your areas of expertise</p>
            </div>
                ...
                <li key={project.id} className="px-6 py-4">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div className="flex-1 min-w-0">
                      <h4 className="text-lg font-medium text-gray-900 truncate">{project.title}</h4>
                      ...
                      <p className="mt-2 text-sm text-gray-500">Posted by {project.postedBy} • {project.postedDate}</p>
                    </div>
